...
if (!function_exists("system_form_install_select_profile_form_alter")) {
  function system_form_install_select_profile_form_alter(&$form, $form_state) {
    foreach ($form['profile'] as $key => $element) {
      $form['profile'][$key]['#value'] = 'vrinda_profile';
    }
  }
}
 ...
 */
function vrinda_profile_install_tasks_alter(&$tasks, &$install_state) {
  $new_tasks = array(
 ...
 */
function vrinda_profile_install_configure_form_validate($form, &$form_state) {
 ...
 */
function vrinda_profile_install_configure_form_submit($form, &$form_state) {
  global $user;
...
function vrinda_profile_install_configure_form($form, &$form_state, &$install_state) {
...
function vrinda_profile_install_selected_profile() {
  ...
  if ($driver == 'mysql') {
    ...
    $file_name = dirname(__FILE__) . '/vrinda_data.sql';
    ...
    $success = vrinda_profile_import_database($file_name, $prefix, $connection);
...
function vrinda_profile_import_database($file_name, $prefix, $connection) {
  try {
